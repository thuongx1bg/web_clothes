...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
            <form method="POST" action="{{route('roles.update',['id'=>$roles->id])}}" enctype="multipart/form-data" style="width: 100%;">
                        @csrf
                <div class="col-md-12" >
                    
                        <div class="form-group">
                            <label for="">Tên vai trò</label>
                            <input type="text" class="form-control " name="name" placeholder="Nhập tên vai trò " value="{{$roles->name}}">
                           
                        </div>

                        <div class="form-group">
                            <label for="">Mô tả vai trò</label>
                            <textarea  id=""  rows="5" name="display_name" class="form-control">{{$roles->display_name}}</textarea>
                        ...
                        <div class="card border-primary mb-3 col-md-12" >
                            ...
                            <div class="card-body text-primary col-md-3">
                                ...
                                <label for="">
                                     ...
                                     }} class="checkbox_children" name="permisstion_id[]" value="{{$permisstionItem->id}}">
                                </label>
